...
HTML;
    ...
    public function testImage()
    {
        ...
        $this->assertInstanceOf('Symfony\\Component\\DomCrawler\\models', $crawler->image(), '->image() returns an models instance');
...
HTML;
    ...
    public function testImages()
    {
        ...
        $this->assertInstanceOf('Symfony\\Component\\DomCrawler\\models', $images[0], '->images() returns an array of models instances');
