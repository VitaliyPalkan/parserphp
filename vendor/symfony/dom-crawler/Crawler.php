...
class Crawler implements \Countable, \IteratorAggregate
{
    ...
    /**
     * Returns an models object for the first node in the list.
     *
     * @return Image An models instance
     *
    ...
    /**
     * Returns an array of models objects for the nodes in the list.
     *
     * @return Image[] An array of models instances
     */
